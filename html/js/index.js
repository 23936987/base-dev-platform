(function ($) {
    ...
    $.learunindex = {
        ...
        loadMenu: function () {
            var data = [{"id":"1","parentId":"0","name":"页面组件","icon":"fa fa-desktop","url":null},{"id":"2","parentId":"1","name":"组件组件","icon":"fa fa-sitemap","url":null},{"id":"3","parentId":"2","name":"输入框组件","icon":"fa fa-sitemap","url":"/page/input.html"},{"id":"4","parentId":"2","name":"下拉框组件","icon":"fa fa-sitemap","url":"/page/combo.html"}];
                        ...
                        $.each(childNodes, function (i) {
                            ...
                            if (subchildNodes.length > 0) {
                                ...
                                $.each(subchildNodes, function (i) {
                                    ...
                                    _html += '<li><a class="menuItem" data-id="' + subchildNodesrow.id + '" href="' + subchildNodesrow.url + '"><i class="' + subchildNodesrow.icon + '"></i>' + subchildNodesrow.name + '</a></li>';
                                });
                                _html += '</ul>';

                            } else {
                                _html += '<a class="menuItem" data-id="' + subrow.id + '" href="' + subrow.url + '"><i class="' + subrow.icon + '"></i>' + subrow.name + '</a>';
                            }
                            _html += '</li>';
                        });
                        _html += '</ul>';
