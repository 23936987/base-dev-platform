...
@Component("parameter.listDomain")
public class ParameterListDomain extends BaseListDomain<ParameterListDTO,ParameterEntity> {
    public ParameterListDomain(){
        this.clazz = ParameterListDTO.class;
