...
@Component("dictList.update")
@TransactionalPrimary
public class DictListUpdateApp extends BaseUpdateApp<DictListEntity> {

    public DictListUpdateApp(){
    }
    @Resource(name="dictList.updateDomain")
    @Override
