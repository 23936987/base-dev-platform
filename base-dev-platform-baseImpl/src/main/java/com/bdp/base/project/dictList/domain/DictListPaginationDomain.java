...
@Component("dictList.paginationDomain")
public class DictListPaginationDomain extends BasePaginationDomain<DictListPaginationDTO,DictListEntity> {
    public DictListPaginationDomain(){
        this.clazz = DictListPaginationDTO.class;
