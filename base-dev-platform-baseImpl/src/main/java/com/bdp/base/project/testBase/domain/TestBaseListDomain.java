...
@Component("testBase.listDomain")
public class TestBaseListDomain extends BaseListDomain<TestBaseListDTO,TestBaseEntity> {
    public TestBaseListDomain(){
        this.clazz = TestBaseListDTO.class;
